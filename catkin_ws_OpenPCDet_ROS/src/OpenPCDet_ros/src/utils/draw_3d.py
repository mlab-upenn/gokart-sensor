...
class Draw3DBox:
    ...
    def publish_3dbox(self, dt_box_lidar, track_ids, inference_time, types=None, publish_id=True, move_lidar_center=20):
        """
        ...
        for i, corners_3d_velo in enumerate(corners_3d_velos):
            ...
            marker.color.a = 1.0
            marker.scale.x = 0.1
            marker.text = str(dt_box_lidar[i])
            ...
            if publish_id and track_ids != -1:
                ...
                text_marker.lifetime = rospy.Duration(20)

...
path = "/home/felix/gokart-sensor/catkin_ws_evaluation/src/evaluation/src/support/2023-02-01-14-57-58"
...
def callback(marker_array):
    ...
    if len(marker_array.markers) > 0:
        if marker_array.markers[0].header.stamp.secs >= float(timestamp_sec):
            if marker_array.markers[0].header.stamp.nsecs >= float(timestamp_nsec) + 35000000: # 275000000 OpenPCDet late fusion     150000000 Darknet
...
def evaluation():
    ...
    rospy.init_node('evaluation_1', anonymous=True)

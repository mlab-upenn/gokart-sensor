...
def generate_launch_description():
    ...
    parameters_file_path = os.path.join(parameters_file_dir, 'dual_ekf_navsat_kart.yaml')
    ...
    launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher',
            name='base_gnss_transform',
	        output='screen',
            arguments = ["-0.396", "0.0", "0.6096", "0", "0", "0", "base_link","gnss"]
           ),
